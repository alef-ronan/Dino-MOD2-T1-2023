...
class Game:
    ...
    def draw_power_up_time(self):
        if self.player.has_power_up:
            ...
            if time_to_show >= 0:
                draw_message_component(
                    f"{self.player.type.capitalize()} enable for {time_to_show} second",
                    self.screen,
                    font_size = 18,
                    pos_x_center = 500,
                    pos_y_center = 40
    ...
    def show_menu(self):
        ...
        if self.death_count == 0:
            ...
            draw_message_component(
                f"Highest Score: {self.highest_score}", self.screen, pos_y_center = half_screen_height + 200
            )
